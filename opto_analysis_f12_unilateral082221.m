f12_sessions = {'2021-08-19', '2021-08-21'};
no_optoflag = [0 0];

f11_acc_sessions = {'2021-07-02', '2021-07-06', '2021-07-07', '2021-07-08',...
    '2021-07-09', '2021-07-14', '2020-07-20', '2021-08-03', '2021-08-04',...
    '2021-08-05', '2021-08-06'};
no_opto_flag_f11_acc = [1, 0, 0, 0, 1, 0, 1, 0, 0, 0, 0]; %these sessions are no-opto sessions
...
f12_acc_sessions = {'2021-07-06', '2021-07-08', '2021-07-09',...
    '2021-07-14', '2021-07-20', '2021-08-03', '2021-08-04', '2021-08-05',...
    '2021-08-06'}; % did not include 07.07 initially?
no_opto_flag_f12_acc = [1, 0, 0, 0, 1, 0, 1, 0, 0, 0, 0];


f11_frontal_sessions = {'2021-08-18'};
f11_frontal_flags = (0);

f11_motor_sessions = {'2021-08-19', '2021-08-20'};
f11_motor_flags = [0 0];

f11_visual_sessions = {'2021-08-21'};
f11_visual_flags = (0);

f12_frontal_sessions = {'2021-08-13', '2021-08-16', '2021-08-17', '2021-08-18'};
% f12_frontal_flags = [0, 0, 0, 0];
% f12_frontal_sessions = {'2021-08-17'};
f12_frontal_flags = [0 0 0 0];

f12_motor_sessions = {'2021-08-19', '2021-08-21'};
f12_motor_flags = [0 0];

f12_visual_sessions = {'2021-08-22'};
f12_visual_flags = (0);

filtered_sessions = f11_motor_sessions;
no_opto_flag = f11_motor_flags;
