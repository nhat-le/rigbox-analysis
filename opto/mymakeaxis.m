...
% add x axis label
thandle = text(mean(xlims(:)),ylims(1)-xaxis.offset-10*xaxis.majorTickLen,xaxis.label,'interpreter',interpreter);
...
% add y axis label
thandle = text(xlims(1)-yaxis.offset-10*yaxis.majorTickLen,mean(ylims(:)),yaxis.label,'interpreter',interpreter);
set(thandle,'HorizontalAlignment','center');
