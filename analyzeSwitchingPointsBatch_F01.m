...
directory = '/Users/minhnhatle/Dropbox (MIT)/Nhat/Rigbox/f01';
files = dir(fullfile(directory, '*/*/*Block.mat'));

% Eliminate bad files
record.name = 'F01';
record.badfiles = {'2021-01-23_1_F01_Block.mat',...
    '2021-01-25_1_F01_Block.mat',...
    '2021-01-26_1_F01_Block.mat',...
    '2021-01-27_1_F01_Block.mat',...
    '2021-01-28_1_F01_Block.mat',...
    '2021-01-29_1_F01_Block.mat',...
    '2021-02-16_2_F01_Block.mat',...
    '2021-02-16_3_F01_Block.mat',...
    '2021-02-24_1_F01_Block.mat',...
    '2021-03-05_1_F01_Block.mat',...
};
...
%% Save the results
% save('F01rigboxSwitchingFits.mat', 'allsigmas', 'alldeltas', 'files', 'options');
...
%     fminsearchOptions = optimset('Display', 'on');
    fminsearchOptions = optimset('PlotFcns',@optimplotfval);
